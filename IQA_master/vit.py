...
class Block1(nn.Module):
    ...
    def __init__(self, dim, num_heads, mlp_ratio=4., qkv_bias=False, drop=0., attn_drop=0.,
        ...
        self.ori = nn.Linear(768, 88)
        self.xlinear = nn.Linear(768, 680)

    def forward(self, x, x_origin):
        #print(x.shape)  # 197,768
        #print(x_origin.shape)  # 196,768
        x_origin = self.ori(x_origin)
        ...
        x_2 = x[:,1:,:]
        #print(x_2.shape)
        x_2 = self.xlinear(x_2)
        #print(x_2.shape)
        
        x = torch.cat(( x_2, x_origin), dim=2)
